                ...
                <div class="col-md-6">
                    ...
                    <div class="col-md-6">
                        <div class="input-group mb-3">
                            ...
                            <button class="btn btn-outline-secondary" type="button" id="ordenarBtn">Ordenar</button>
                        </div>
                    </div>
                </div>
            </div>
...
<script>
    // Función para realizar la búsqueda de perros
    $('#buscar').click(function () {
        var textoBusqueda = $('#busqueda').val();
        // Realiza una solicitud AJAX al servlet para obtener los perros que coinciden con la búsqueda
        $.ajax({
            url: 'SvPerro?nombre=' + textoBusqueda, // Cambia 'nombre' por el nombre del parámetro que esperas en tu servlet
            method: 'GET',
            success: function (data) {
                // Actualiza el contenido de la tabla con los resultados de la búsqueda
                $('tbody').html(data);
            },
            error: function () {
                // Maneja errores aquí si es necesario
                console.log('Error al realizar la búsqueda de perros.');
            }
        });
    });

    // Función para realizar la ordenación de la tabla
    $('#ordenarBtn').click(function () {
        var columna = $('#ordenar').val();
        // Realiza una solicitud AJAX al servlet para ordenar la tabla por la columna seleccionada
        $.ajax({
            url: 'SvPerro?ordenar=' + columna, // Cambia 'ordenar' por el nombre del parámetro que esperas en tu servlet
            method: 'GET',
            success: function (data) {
                // Actualiza el contenido de la tabla con los resultados de la ordenación
                $('tbody').html(data);
            },
            error: function () {
                // Maneja errores aquí si es necesario
                console.log('Error al ordenar la tabla de perros.');
            }
        });
    });
